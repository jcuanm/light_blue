...
ONGOING, MATE, STALEMATE = range(3)
...
class Board( object ):
    ...
    def set_blank(self, cols=8, rows=8):
        ...
        self.cols = cols
        self.rows = rows
        self.squares = tuple( [None for _ in xrange(self.rows)] for _ in xrange(self.cols) )
...
class Move(object):
    ...
    PLAIN, CASTLE_QUEENSIDE, CASTLE_KINGSIDE, EN_PASSANT= range( 4 )
